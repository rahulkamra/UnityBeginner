...
public static class Noise
{
    ...
    public static NoiseMethod[] ValueMethods = { Noise.Value1D, Noise.Value2D, Noise.Value3D };
    public static NoiseMethod[] PerlinMethods = { Noise.Perlin1D, Noise.Perlin2D, Noise.Perlin3D };
